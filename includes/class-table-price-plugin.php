...
class TablePricePlugin {
    ...
    public function enqueue_scripts() {
        ...
        // Підключення кастомних стилів плагіна для фронтальної частини
        wp_enqueue_style('custom-plugin-styles', plugin_dir_url(__DIR__) . 'assets/css/custom-styles.css', array(), time());
}
